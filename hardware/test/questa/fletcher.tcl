...
proc add_interconnect_tb {{source_dir ""}} {
  ...
  add_source $source_dir/interconnect/test/BusReadWriteSlaveMock.vhd
...
proc add_mm {{source_dir ""}} {
  ...
  add_source $source_dir/mm/MMGapFinderStep.vhd
...
proc add_mm_tb {{source_dir ""}} {
  ...
  set source_dir [source_dir_or_default $source_dir]
  add_source $source_dir/mm/test/MM_tc_params.vhd
  add_source $source_dir/mm/test/BusReadWriteSlaveMock_tc.vhd
  add_source $source_dir/mm/test/MMBarrier_tc.vhd
  add_source $source_dir/mm/test/MMDirector_tc.vhd
  add_source $source_dir/mm/test/MMFrames_tc.vhd
  add_source $source_dir/mm/test/MMSystem_tc.vhd
  add_source $source_dir/mm/test/MMTranslator_tc.vhd
}
