...
int main()
{
  ...
  std::vector<std::shared_ptr<arrow::Field>> schema_fields = {
    arrow::field("weight0", arrow::int64(), false),
    arrow::field("weight1", arrow::int64(), false),
    arrow::field("weight2", arrow::int64(), false),
    arrow::field("weight3", arrow::int64(), false),
    arrow::field("weight4", arrow::int64(), false),
    arrow::field("weight5", arrow::int64(), false),
    arrow::field("weight6", arrow::int64(), false),
    arrow::field("weight7", arrow::int64(), false)
  };
